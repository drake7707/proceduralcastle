...
var BaseCreator = (function () {
    function BaseCreator() {
        this.imgurClientId = "d3c0f0cb829f983";
    }
    BaseCreator.prototype.getImageElement = function () {
        var img = $("<img/>");
        var datastring = "data:" + this.getMimeType() + ";base64," + this.resultBase64;
        img.attr("src", datastring);
        return img.get(0);
    };
    BaseCreator.prototype.uploadToImgur = function (title, description, onDone) {
    ...
    BaseCreator.prototype.updateImgurDescription = function (description) {
        var self = this;
        $.ajax({
...
var PngCreator = (function (_super) {
    __extends(PngCreator, _super);
    function PngCreator() {
        _super.call(this);
    }
    PngCreator.prototype.setImage = function (canvas) {
        this.resultBase64 = canvas.toDataURL().split(',')[1];
    };
    PngCreator.prototype.getMimeType = function () {
        return "image/png";
    };
    return PngCreator;
})(BaseCreator);
exports.PngCreator = PngCreator;
var GIFCreator = (function (_super) {
    __extends(GIFCreator, _super);
    function GIFCreator(nrWorkers, quality) {
        if (nrWorkers === void 0) { nrWorkers = 2; }
    ...
    GIFCreator.prototype.getMimeType = function () {
        return "image/gif";
    };
